        ...
        ScrollView {
            VStack {
                ZStack(alignment: .trailing) {
                    ...
                    NavigationLink(destination: PredatorImage(predator: predator).navigationBarBackButtonHidden()) {
                ...
                VStack(alignment: .leading) {
                    ...
                    ForEach(predator.movies, id: \.self) { movie in // Identifiable needs an id property, you can add with id: \.self, uses string itself for id
                        Text("•" + movie) // CMD-CTRL-Space to bring up Emoji Selector
                            .font(.subheadline)
                    }
